...
Econometrics could be reduced to simple statistics... 
- yet, it has a clearer connection to (economic) theory
  - this is also why it is interesting for causal inference and thinking
...
Spatial Lag Y / Spatial Autoregressive Model:
