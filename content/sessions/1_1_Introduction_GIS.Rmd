...
**A lot of the materials stem from previous courses but were updated and refined in preperation of this one. I'd like to thank my wonderful colleague Anne-Kathrin Stroppe for her value contribution to this corpus** 
...
## I am (Necessarily) Selective

There's a multitude of spatial `R` packages
- I cannot cover all of them
  - and we cannot cover all functions
- You may have used some I am not familiar with

I show the use of packages I exploit in practice
...
.center[`https://github.com/StefanJuenger/gis_socsci_konstanz`]
...
- Shapefiles, voting data, and Covid cases for Cologne are gathered from the [Open Data Portal Cologne](https://www.offenedaten-koeln.de/)
...
[Exercise](https://stefanjuenger.github.io/gis_socsci_konstanz/exercises/1_1_1_Package_Installation.html)

[Solution](https://stefanjuenger.github.io/gis_socsci_konstanz/solutions/1_1_1_Package_Installation.html)
...
woRkshoptools::include_picture("on_writing_king.jpg")
```
...
I heavily use namespace declarations in code: `::`. It's a way to safely call a function if there are the same function names in other packages loaded. Usually, you don't need that, but it's a transparent way to show from which package you call which function. 
