...
# import data
hospitals_sf <- 
    readr::read.csv("./data/hospital_points.csv", 
                    header = T, fill = T, sep = ",") %>%
...
party_palette_fcts <- map(party_colors, ~ colorRampPalette(c("#FFFFFF",.x)))
...
## The Corresponding Code for the Election Results
