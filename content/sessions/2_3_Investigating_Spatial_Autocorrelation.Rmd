...
voting_districts <-
  ...
  # sf::st_read(as_tibble = TRUE, quiet = TRUE) %>%
...
[Exercise](https://stefanjuenger.github.io/gis_socsci_konstanz/exercises/2_3_1_Neighborhood_Matrices.html)

[Solution](https://stefanjuenger.github.io/gis_socsci_konstanz/solutions/2_3_1_Neighborhood_Matrices.html)

---

## Measures of local spatial autocorrelation: LISA clusters

The reason why I show you the `sfdep` package is that it provides nice functions to calculate *local* measures of spatial autocorrelation. One popular choice are the estimation of Local Indicators of Spatial Autocorrelation (i.e., LISA clusters). In the most straightforward way they can be interpreted as case-specific indicators of spatial autocorrelation:
